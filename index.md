...
- 大数据与人工智能技术为石油钻井工况监测带来新机遇。物联网通信技术在钻井现场的应用积累了大量工况数据，为挖掘数据规律及识别特征模式提供了可能。通过云边端协同技术，综合考虑处理延时、带宽消耗与数据安全。本项目拟探索构建基于大规模钻井工况数据的工况异常识别方法，来准确判断工况状态，实现石油钻井的异常工况智能识别。
