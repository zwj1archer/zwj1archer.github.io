...
# 🌟招生
## 我们致力于让机器拥有更智能的“眼睛”和“大脑”，研究方向聚焦于：
- 智能视觉感知：赋能机器视觉，提升复杂环境下的识别能力，拓展安防与工业检测应用。
- 医学影像智能分析：融合人工智能，辅助临床诊断与影像判读，提升诊疗效率。
- 智能油气工程：驱动能源行业智能化，保障作业安全并优化生产运营。
  
## 👋 **我们拥有良好的科研平台、浓厚的团队氛围和丰富的实践机会。如果你对计算机视觉、机器学习、人工智能应用充满热情，欢迎加入我们！** 👋
## ✨ **让我们携手，探索视觉与智能的边界，让AI看懂世界！** ✨
![我的照片](Photo.jpg)
# 研究经历
## 智能视觉感知方向
...
- 中国空气动力研究与发展中心 结冰与防除冰重点实验室 开放基金项目（主持）
- 探索云雾环境下飞行器结冰视觉检测方法，采用视觉感知的机制进行云雾环境下结冰状况检测与识别。

### 面向公共场景安全的视觉目标异常行为检测研究 2023.01 - 2024.12
- 四川省科技厅自然科学基金 面上项目（主持）
...
### 基于多源数据融合的城市交通拥堵状态判别与预测研究 2024.01 - 至今
- 智能警务四川省重点实验 开放基金项目（主持）
...
### 跨模态时序融合手语翻译关键技术研究：RGB-D与骨骼异构数据动态协同建模进行自然语言转化 2025.06 - 至今
- 特殊教育语言智能四川省哲学社会科学重点实验室 开放基金项目 （主持）
- 本研究针对手语翻译系统中跨模态协同弱、语义对齐不足等问题，重点研究异构模态动态协同建模与多粒度特征对齐机制，通过融合RGB-D与骨骼数据，构建跨模态时序翻译模型，实现从视觉输入到自然语言的高效转化。
...
### 多模态神经影像情绪处理机制探索与智能识别研究 2026.01-至今
- 合作：余思奕 成都中医药大学
- 情绪障碍（如抑郁症、焦虑症）是一类常见的精神心理疾病，若未及时干预可能进一步恶化为严重精神疾病，因此客观评估情绪状态对早期诊断与治疗具有重要意义。功能性近红外光谱（fNIRS）作为一种非侵入性脑成像技术，能够通过测量大脑皮层局部血氧变化，反映不同情绪状态下前额叶及颞叶等关键脑区的活动特征。本研究旨在结合fNIRS、EEG等神经影像技术与人工智能方法，构建智能识别模型，实现情绪智能识别与关键脑区定位，获取情绪障碍的显著神经影像生物标记，为临床客观诊断、早期筛查及疗效监测提供数据支撑。

### MRI影像表征学习驱动的脑认知疾病智能判别与可解释性方法研究 2026.07-至今
- 核医药与辐射安全防控四川省重点实验室开放课题（主持）
- 随着人口老龄化加剧，阿尔茨海默病等脑认知疾病发病率上升，早期症状隐匿、诊断困难。扩散MRI能捕捉脑白质微结构与连接通路早期异常，但如何从海量异质MRI中学习稳定可解释的特征并构建精准判别模型，仍是核心挑战。本研究拟：1）以扩散MRI为核心整合多维影像，构建刻画局部微结构与全局连接模式的脑多层次结构化表征；2）设计数据驱动模型自动挖掘判别性特征，实现精准智能分类；3）通过可视化与归因分析解析关键影像表征，使模型决策具备明确的神经解剖学依据。推动可解释智能诊断范式发展，助力脑认知疾病早期筛查与精准分型，具有重要科学价值。

## 智能油气工程方向
### 石油钻井工程异常工况智能检测方法研究 2024.01 - 至今
...
### 云边端协同的石油钻井工程异常工况智能识别方法研究 2024.10 -至今
...
# 学术论文
## 2026年度
- **Wenjun Zhou**, Yihan Zhang, Xinlong Yang, Xiyu Chen, Bo Peng*. "A Kalman adaptive loss-driven deep learning model for multi-step pressure prediction in hydraulic fracturing." Comput Geosci 30, 92 (2026). (**SCI, IF: 2.1**)
...
- 四川省人工智能学会 理事
- 2025年度中国石油化工自动化应用协会科技进步三等奖: 油气施工作业现场智能监管关键技术及应用
